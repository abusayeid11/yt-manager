...
def get_transcript_json(input_str):
    ...
    for snippet in transcript:
        snippets.append({"text": snippet.text, "start": snippet.start, "duration": snippet.duration})

    result = {"videoId": video_id, "snippets": snippets}
